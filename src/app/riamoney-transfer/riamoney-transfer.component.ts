...
@Component({
  selector: 'app-riamoney-transfer',
  templateUrl: './riamoney-transfer.component.html',
  styleUrls: ['./riamoney-transfer.component.css']
})
export class RIAmoneyTransferComponent implements OnInit {
  modalRef: BsModalRef;
  currency;Country;
