...
@Component({
  selector: 'app-domestic-wire-transfer',
  templateUrl: './domestic-wire-transfer.component.html',
  styleUrls: ['./domestic-wire-transfer.component.css']
})
export class DomesticWireTransferComponent implements OnInit {
  modalRef: BsModalRef;
  currency;Country;
