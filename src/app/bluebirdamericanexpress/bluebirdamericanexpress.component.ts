...
@Component({
  selector: 'app-bluebirdamericanexpress',
  templateUrl: './bluebirdamericanexpress.component.html',
  styleUrls: ['./bluebirdamericanexpress.component.css']
})
export class BluebirdamericanexpressComponent implements OnInit {
  modalRef: BsModalRef;
  currency;Country;
