...
@Component({
  selector: 'app-international-wire-transfer',
  templateUrl: './international-wire-transfer.component.html',
  styleUrls: ['./international-wire-transfer.component.css']
})
export class InternationalWireTransferComponent implements OnInit {
