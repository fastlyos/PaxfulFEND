...
@Component({
  selector: 'app-greendotcard',
  templateUrl: './greendotcard.component.html',
  styleUrls: ['./greendotcard.component.css']
})
export class GreendotcardComponent implements OnInit {
