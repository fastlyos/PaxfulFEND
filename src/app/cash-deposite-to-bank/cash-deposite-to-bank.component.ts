...
@Component({
  selector: 'app-cash-deposite-to-bank',
  templateUrl: './cash-deposite-to-bank.component.html',
  styleUrls: ['./cash-deposite-to-bank.component.css']
})
export class CashDepositeToBankComponent implements OnInit {
