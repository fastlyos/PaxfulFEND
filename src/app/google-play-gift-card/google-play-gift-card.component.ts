...
@Component({
  selector: 'app-google-play-gift-card',
  templateUrl: './google-play-gift-card.component.html',
  styleUrls: ['./google-play-gift-card.component.css']
})
export class GooglePlayGiftCardComponent implements OnInit {
  modalRef: BsModalRef;
  currency;Country;
