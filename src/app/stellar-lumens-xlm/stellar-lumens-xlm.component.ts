...
@Component({
  selector: 'app-stellar-lumens-xlm',
  templateUrl: './stellar-lumens-xlm.component.html',
  styleUrls: ['./stellar-lumens-xlm.component.css']
})
export class StellarLumensXLMComponent implements OnInit {
  modalRef: BsModalRef;
  currency;Country;
