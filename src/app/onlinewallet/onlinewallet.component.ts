...
@Component({
  selector: 'app-onlinewallet',
  templateUrl: './onlinewallet.component.html',
  styleUrls: ['./onlinewallet.component.css']
})
export class OnlinewalletComponent implements OnInit {
  modalRef: BsModalRef;
  currency;Country;
