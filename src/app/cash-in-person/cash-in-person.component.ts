...
@Component({
  selector: 'app-cash-in-person',
  templateUrl: './cash-in-person.component.html',
  styleUrls: ['./cash-in-person.component.css']
})
export class CashInPersonComponent implements OnInit {
