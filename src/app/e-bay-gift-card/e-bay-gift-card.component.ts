...
@Component({
  selector: 'app-e-bay-gift-card',
  templateUrl: './e-bay-gift-card.component.html',
  styleUrls: ['./e-bay-gift-card.component.css']
})
export class EBayGiftCardComponent implements OnInit {
  modalRef: BsModalRef;
  currency;Country;
