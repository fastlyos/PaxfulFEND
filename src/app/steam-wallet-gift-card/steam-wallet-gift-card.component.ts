...
@Component({
  selector: 'app-steam-wallet-gift-card',
  templateUrl: './steam-wallet-gift-card.component.html',
  styleUrls: ['./steam-wallet-gift-card.component.css']
})
export class SteamWalletGiftCardComponent implements OnInit {
  modalRef: BsModalRef;
  currency;Country;
