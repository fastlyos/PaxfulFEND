...
@Component({
  selector: 'app-i-tunes-gift-card',
  templateUrl: './i-tunes-gift-card.component.html',
  styleUrls: ['./i-tunes-gift-card.component.css']
})
export class ITunesGiftCardComponent implements OnInit {
  modalRef: BsModalRef;
  currency;Country;
